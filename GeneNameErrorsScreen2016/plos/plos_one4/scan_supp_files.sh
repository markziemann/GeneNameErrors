...
SUPPFILELIST=supp_file_urls.txt		#Might not need this
...
wget --content-disposition -P $TEMP_DIR $SUPP_URL
TEMP_FILE=`ls $TEMP_DIR/*`
...
| parallel --delay 3 -j$PARALLEL_JOBS scanit "{}" "$GENELIST_DIR"
